...
var pJS = function (tag_id, params) {
  ...
  pJS.fn.retinaInit = function () {
    if (pJS.retina_detect && globalThis.devicePixelRatio > 1) {
      pJS.canvas.pxratio = globalThis.devicePixelRatio
      pJS.tmp.retina = true
    } else {
  ...
  pJS.fn.vendors.createSvgImg = function (p) {
    ...
    var svg = new Blob([coloredSvgXml], { type: 'image/svg+xml;charset=utf-8' }),
      DOMURL = globalThis.URL || globalThis.webkitURL || window,
  ...
  pJS.fn.vendors.exportImg = function () {
    globalThis.open(pJS.canvas.el.toDataURL('image/png'), '_blank')
  }
...
globalThis.cancelRequestAnimFrame = (function () {
  return (
...
globalThis.particlesJS = function (tag_id, params) {
  //console.log(params);
...
globalThis.particlesJS.load = function (tag_id, path_config_json, callback) {
  /* load json config */
  var xhr = new XMLHttpRequest()
  ...
  xhr.onreadystatechange = function (data) {
    if (xhr.readyState == 4) {
      if (xhr.status == 200) {
        ...
        globalThis.particlesJS(tag_id, params)
...
export default globalThis.particlesJS
